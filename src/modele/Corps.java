...
{	
	...
	/**
	 * Retourne la propriété pour la position en X.
	 * Utile pour le binding.
	 * @return Propriété de la position en X.
	 */
	DoubleProperty getPositionXProperty();
	
	/**
	 * Retourne la propriété pour la position en Y.
	 * Utile pour le binding.
	...
	/**
	 * Retourne la force extérieure appliquée sur le corps.
	 * Par exemple, la force peut être créée par un réacteur.
